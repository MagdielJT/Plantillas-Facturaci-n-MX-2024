 ...
 */
define(['N/https', 'N/log', 'N/record', 'N/format', 'N/search', 'N/currency', 'N/config', 'N/runtime', 'SuiteBundles/Bundle 342702/MX+ 2024/Utilities/EFX_FE_Lib', 'N/crypto/random','../Lib/mx_plus_cartaporte_lib'],
    /**
 * @param{log} log
 */
    (https, log, record, format, search, modcurrency, config, runtime, libCFDI, crypto,cartaporte_lib) => {
        /**
        ...
        const onRequest = (scriptContext) => {
            ...
            var datosPac = dataPac(obj_json_cp);
            scriptContext.response.write({ output: JSON.stringify(obj_json_cp) })
