 ...
 */
    (log, record, search, libCFDI, runtime, config) => {
        ...
        const getMercancias = (id_transaccion) => {
            var data_to_return = {
                PesoBrutoTotal: 0,
                UnidadPeso: '',
                NumTotalMercancias: '',
            ...
            for (let i = 0; i < numLinesItems; i++) {
                ...
                var item_peso_bruto = record_transaccion.getSublistValue({
                    sublistId: "item",
                    fieldId: "custcol_efx_fe_cp_pesobruto",
                    line: i
                });
                ...
                // var peso = item_peso_bruto * item_quantity;
                // peso_neto = parseFloat(peso_neto) + peso;
                // data_to_return.PesoBrutoTotal = parseFloat(data_to_return.PesoBrutoTotal) + parseFloat(item_peso_bruto);
            }
            ...
            var partialMercanciaInfo = getItemCP_Information(items_id, items_custom_object);
            ...
            partialMercanciaInfo.forEach((item, index) => {
                ...
                peso_neto = parseFloat(peso_neto) + peso;
                data_to_return.PesoBrutoTotal = parseFloat(data_to_return.PesoBrutoTotal) + parseFloat(peso);
            });
            ...
            data_to_return.PesoBrutoTotal = data_to_return.PesoBrutoTotal + ''
        ...
        const fetchVehiculo = (id_vehiculo, pesoVehicular) => {
            var data_to_return = {
                ...
                "IdentificacionVehicular": {
                    "ConfigVehicular": '',
                    "PesoBrutoVehicular": pesoVehicular + '',
                    "PlacaVM": '',
                    "AnioModeloVM": ''
                }
            ...
            try {
                ...
                var data_to_return = {
                    ...
                    "IdentificacionVehicular": {
                        ...
                        "PesoBrutoVehicular": vehiculo_obj.IdentificacionVehicular.PesoBrutoVehicular,
        ...
        const getItemCP_Information = (item_ids, arrItemCustomObject) => {
            try {
                var data_to_return = [];
                var arr_items_info = [];
                ...
                for (let i = 0; i < itemSearchPagedData.pageRanges.length; i++) {
                    ...
                    itemSearchPage.data.forEach((result) => {
                        ...
                        var data = { internalId, itemId, displayName, salesDescription, cpUnidadDePeso, cppesoenkg, cpMaterialPeligroso, satItemCode, cveMatPeligroso, codigoEmbalaje };
                ...
                newArray.forEach((item, index) => {
                    ...
                    dataMercancia.PesoEnKg = item.cppesoenkg;
        ...
        return { getFolderTimb, getMercancias, fetchFiguraTransporte, validateFields, isMexicanSubsidiary, isMexicanCompany }
