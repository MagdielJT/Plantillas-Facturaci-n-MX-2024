...
<cfdi:Comprobante
        ...
        <#if transaction.custbody_mx_cfdi_sat_addendum?has_content>
...
<#assign tieneobjimp = tieneobjimp+1>
                        ...
                        ${getNodePair("cfdi:InformacionAduanera", "NumeroPedimento" ,item.custcol_tk_pedimento)}
...
<#assign tieneobjimp = tieneobjimp+1>
    ...
    <#if tieneobjimp gt 0>
        ...
        <#assign "Addenda2" = transaction.custbody_mx_plus_addenda_pt2>
        <#assign "Addenda3" = transaction.custbody_mx_plus_addenda_pt_3>
                ...
                <cce20:Mercancias>
                    <#list custom.items as customItem>
                        ...
                        <cce20:Mercancia
                            ...
                            ValorUnitarioAduana="${item.custcol_efx_fe_ce_val_uni_aduana?replace(',','')?number}"
                    ...
                    <#list custom.items as customItem>
                        ...
                        <cartaporte20:Mercancia ${getAttrPair("BienesTransp",(itemSatCodes.itemCode)!"")!""}
                            ...
                            <#if item.custcol_mx_txn_line_sat_cust_req_num?has_content>
                                <cartaporte20:Pedimentos Pedimento="${item.custcol_tk_pedimento}"/>
                            </#if>
        ...
        <#if Addenda?has_content>
            <#assign "Addenda_all" = Addenda_all+ Addenda>
        </#if>
        <#if Addenda2?has_content>
            <#assign "Addenda_all" = Addenda_all+ Addenda2>
        </#if>
        <#if Addenda3?has_content>
            <#assign "Addenda_all" = Addenda_all+ Addenda3>
        </#if>
        <#if Addenda?has_content>
            ${Addenda_all?replace("&gt;", ">")?replace("&lt;", "<")?replace("<br />","")}
        </#if>
