    ...
    <#if certData?has_content>
        ...
        <table class="total" style="width: 100%; margin-top: 10px; border: 1px; border-color: #e3e3e3;">
            ...
            <#if record.custbody_efx_fe_related_cfdi_json?has_content>
                <tr>
                    <td colspan="8" style="font-size:90%;"><b>Documentos Relacionados:</b></td>
                </tr>
                ...
                <#if relatedOBJ?has_content>
                    ...
                    <#list obj as objeto>
                        <tr>
                            <td colspan="2" width=" 72px" style="font-size:90%; padding-left: 12px;font-size: 6pt;">
                                Folio: &nbsp; ${objeto.fol}
                            </td>
                            <td colspan="2" width=" 72px" style="border-left: 1px; border-color: #e3e3e3;font-size:90%; font-size: 6pt;">
                                Tipo: &nbsp; ${objeto.type}
                            </td>
                            <td colspan="3" width=" 72px" style="border-left: 1px; border-color: #e3e3e3;font-size:90%; font-size: 6pt;">
                                UUID: &nbsp; ${objeto.uuid}
                            </td>
                        </tr>
                    </#list>
