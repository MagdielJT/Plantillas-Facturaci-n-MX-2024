                ...
                <table class="header" height="70px" style="width: 100%;">
                    <tr height="70px">
                        ...
                        <td colspan="6" height="70px">
                            ...
                            <#elseif record.custbody_efx_fe_logosub?has_content>
                                <#assign "urldir" = "http://8333310.shop.netsuite.com" + record.custbody_efx_fe_logosub>
                                <img width="140" height="70" src="${urldir}"/>
        ...
        <#if record.custbody_efx_fe_kiosko_customer?has_content>
            <table style="width: 100%; margin-top: 10px;">
                <tr>
                    ...
                    <td></td>
                    <td class="body" colspan="14" style="background-color: #e3e3e3; font-size:9px"><b>Emisor</b></td>
                </tr>
                <tr>
                ...
                <tr>
                  ...
                  <td colspan="14" rowspan="2" style="border: 1px; border-color: #e3e3e3; font-size:9px;">
                    <#if record.subsidiary?has_content>    
                        <#if record.subsidiary.custrecord_mx_sat_registered_name?has_content>
                            ${record.subsidiary.custrecord_mx_sat_registered_name?upper_case}
                        </#if>
                        <#if (record.subsidiary.federalidnumber?length > 0) && record.subsidiary.federalidnumber?keep_before(":") != "ERROR">
                          <br/><br/><b>RFC:</b> ${record.subsidiary.federalidnumber}
                        <#elseif record.custbody_ex_fe_cp_json_dir?has_content>
                          <#assign dataDirCE = record.custbody_ex_fe_cp_json_dir?eval>
                          <br/><br/><b>RFC:</b> ${dataDirCE.emisor.Rfc}
                        <#else>
                          <br/><br/><b>RFC:</b> ${record.subsidiary.custrecord_mxplus_pac_email?keep_after("-")?keep_before("@")}
                        </#if>
                        <br/><br/><b>Régimen Fiscal:</b> ${record.subsidiary.custrecord_mx_sat_industry_type?upper_case}
                    <#else>
                ...
                <#else>
                    ...
                    <td colspan="14" rowspan="2" style="border: 1px; border-color: #e3e3e3; font-size:9px;">
                        <#if record.subsidiary?has_content>
                            ...
                            <br/><br/><b>Régimen Fiscal:</b> ${subsidiary.custrecord_mx_sat_industry_type?upper_case}
                        <#else>
                          ${companyInformation.legalname?upper_case}
                          <br/><br/><b>RFC:</b> ${companyInformation.employerid}
                          <br/><br/><b>Régimen Fiscal:</b> ${infoEmpresa.custrecord_mx_sat_industry_type?upper_case}
        ...
        <table class="itemtable" style="width: 100%; margin-top: 3px; border: 1px; border-color: #e3e3e3;">
            <#if dataXML.Conceptos.Concepto?is_sequence>
                ...
                <tr style="margin-top: 0px; padding-top: 0px; padding-bottom: 0px">
                    ...
                    <th align="center" colspan="2"
                        style="font-size: 5pt; padding-left: 0px; padding-right: 0px;">Unidad
                    </th>
                    <th align="center" colspan="5"
            ...
            <#else>
                ...
                <tr style="margin-top: 0px; padding-top: 0px; padding-bottom: 0px">
                    ...
                    <th align="center" colspan="5" style="font-size: 6pt; padding-left: 0px; padding-right: 0px;">Código<br/>Clave
                    </th>
                    <th align="center" colspan="18" style="font-size: 6pt; padding-left: 0px; padding-right: 0px;">
                        <table style="width: 100%; margin-top: 0px; margin-bottom: 0px; border: 1px; border-color: #e3e3e3">
                            <tr>
                                <th align="center" colspan="18" vertical-align="top"
                                    style="font-size: 6pt; padding-top: 0px; padding-bottom: 2px; padding-left: 0px; padding-right: 0px;">
                                    Descripción
                                </th>
                            </tr>
                            <tr>
                                <td colspan="18" style="border-left: 1px; border-color: #e3e3e3;">
                                    <table style="width: 100%; margin-top: 0px; margin-bottom: 0px;">
                                        <tr>
                                            <td align="left" colspan="4"
                                                style="font-size: 6pt; padding-top: 0px; padding-bottom: 0px;">Base
                                            </td>
                                            <td align="left" colspan="3"
                                                style="font-size: 6pt; padding-top: 0px; padding-bottom: 0px;">Factor
                                            </td>
                                            <td align="left" colspan="3"
                                                style="font-size: 6pt; padding-top: 0px; padding-bottom: 0px;">Tasa
                                            </td>
                                            <td align="left" colspan="4"
                                                style="font-size: 6pt; padding-top: 0px; padding-bottom: 0px;">Importe
                                            </td>
                                        </tr>
                                    </table>
                                </td>
                    ...
                    <th align="center" colspan="5" style="font-size: 6pt; padding-left: 0px; padding-right: 0px;">UPC
                    </th>
                    <th align="center" colspan="4" style="font-size: 6pt; padding-left: 0px; padding-right: 0px;">
                        Cantidad
                    </th>
                    <th align="center" colspan="4" style="font-size: 6pt; padding-left: 0px; padding-right: 0px;">Precio
                        sin<br/>impuesto
                    </th>
