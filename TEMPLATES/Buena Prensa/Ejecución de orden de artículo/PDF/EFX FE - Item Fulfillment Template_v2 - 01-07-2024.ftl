        ...
        <td colspan="6" rowspan="3">
          <#if certData?has_content>
            <#if record.custbody_efx_fe_logosub?has_content>
              <img height="70%" src="${record.custbody_efx_fe_logosub}" style="float: left; margin: 2px" width="75%" />
            </#if>
          <#else>
            <#if record.custbody_efx_fe_logosub?has_content>
              <#if subsidiary.logo@url?length != 0>
                <img height="70%" src="${subsidiary.logo@url}" style="float: left; margin: 2px" width="75%" />
              <#elseif companyInformation.logoUrl?length != 0>
                <img height="70%" src="${companyInformation.logoUrl}" style="float: left; margin: 2px" width="75%" />
              </#if>
            </#if>
          </#if>
        </td>
