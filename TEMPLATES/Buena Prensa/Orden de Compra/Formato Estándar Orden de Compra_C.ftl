...
<body header="nlheader" header-height="16%" footer="nlfooter" footer-height="20pt" padding="0.5in 0.5in 0.5in 0.5in" size="Letter">
  ...
  <table width="100%" style="font-size: 9pt; margin-top: 5px;">
    <tr>
      ...
      <#if (record.custbody_mx_txn_sat_payment_term?length > 0) || (record.custbody_mx_txn_sat_payment_method?length > 0) || (record.custbody_mx_cfdi_usage?length > 0)>
        <td width = "60%">
          <table>
            <tr>
              <td>
            ...
            <tr>
              ...
              <td>
                ${record.custbody_mx_txn_sat_payment_term?keep_before(' ')}
              </td>
            </tr>
            <tr>
              <td>
              ...
              <td>
                ${record.custbody_mx_txn_sat_payment_method}
              </td>
            </tr>
            <tr>
              <td>
              ...
              <td>
                ${record.custbody_mx_cfdi_usage}<br />
              </td>
            </tr>
            <tr>
              <td>
              ...
              <td>
                ${record.custbody_mxplus_numinvoice}
                <#--  ${record.memo}  -->
                <#--  <#list record.link as link>  -->
                  <#--  <#assign data = link?eval>
                  <#list link as data>  -->
                    <#--  <#if link.type == "Factura">  -->
                      <#--  ${link.id}<br />  -->
                    <#--  </#if>  -->
                  <#--  </#list>  -->
                <#--  </#list>  -->
  ...
  <#if record.item?has_content>
    <table class="itemtable" style="width: 100%; font-size: 7pt;"><!-- start items -->
  ...
  <#elseif record.expense?has_content>
    <table class="itemtable" style="width: 100%; font-size: 7pt;"><!-- start expenses -->
      <#list record.expense as expense>
        <#if expense_index==0>
          <thead style="padding:1px; margin:1px">
            <tr>
              <th align="center" colspan="2" style="padding:2px;">Cant </th>
              <th align="center" colspan="4" style="padding:2px;"> Cuenta</th>
              <th align="center" colspan="2" style="padding:2px;">Importe</th>
              <th align="center" colspan="2" style="padding:2px;">Importe<br />Impuesto</th>
              <th align="center" colspan="2" style="padding:2px;">Importe Bruto</th>
              <th align="center" colspan="4" style="padding:2px;">Departamento</th>
            </tr>
          </thead>
        </#if>
        <tr>
          <td align="center" colspan="2"></td>
          <td align="center" colspan="4"> ${expense.account} </td>
          <td align="center" colspan="2">${expense.amount}</td>
          <td align="center" colspan="2">${expense.tax1amt}</td>
          <td align="center" colspan="2">${expense.grossamt}</td>
          <td align="center" colspan="4">${expense.department}</td>
        </tr>
      </#list><!-- end expenses -->
    </table>
  </#if>
