...
<#else>
<#setting time_zone= "America/Tijuana">
</#if>
                                            ...
                                            <pago20:TrasladosDR>
                                                <#list impuestosPago.bases_iva as ivaRate, ivaValue>
                                                    ...
                                                    <pago20:TrasladoDR
                                                        ...
                                                        <#if montoimpuestosPago gt 0>
                                                            <#if transaction.currencysymbol == "USD">
                                                                <#if rateimpuestosPago?number?string["0.00"] == "0.16">
                                                                    ...
                                                                    <#assign auxImporte = (((montoimpuestosPago/1.16?number))?string['0.00']?number)*0.16>
                                                                <#elseif rateimpuestosPago?number?string["0.00"] == "0.08">
                                                                    BaseDR="${((montoimpuestosPago/1.08?number))?string['0.00']}"
                                                                <#elseif rateimpuestosPago?number?string["0.00"] == "0.00">
                                                                    BaseDR="${(montoimpuestosPago)?string['0.00']}"
                                                                <#else>
                                                            ...
                                                            <#else>
                                                                <#if rateimpuestosPago?number?string["0.00"] == "0.16">
                                                                    ...
                                                                    <#assign auxImporte = (((txnitem.amount)/1.16)?string["0.00"]?number)*0.16>
                                                        ...
                                                        <#if auxImporte != 0>
                                                            ImporteDR="${(auxImporte)?string['0.00']}
                                                        <#else>
                                ...
                                <#list ImpuestosPTraslados_base as baseTkey, baseTvalue>
                                    ...
                                    <#if desglosa_ieps == true>
                                        ...
                                        <#if impuestoPType!="003">
                                            ...
                                            <#else>
                                                <#if suma_baseDR gt 0>
                                                    <pago20:TrasladoP BaseP="${suma_baseDR?string("##0.00;; roundingMode=down")}" ImpuestoP="${impuestoPType}" TipoFactorP="Tasa" TasaOCuotaP="${tasaCuota?string["0.000000"]}" <#if ImportePIVA16?number gte 0 && tasaCuota?string["0.000000"] == "0.160000">ImporteP="${(suma_baseDR*0.16)?string["0.00"]}"<#elseif ImportePIVA8?number gt 0 && tasaCuota?string["0.000000"] == "0.080000">ImporteP="${ImportePIVA8}"<#else><#if transaction.custbody_efx_fe_moneda.symbol == "MXN" && transaction.currencysymbol == "USD">ImporteP="${(((ImpuestosPTraslados_importe[baseTkey]?string["0.00"])?number*tasaCuota?number)/tipocambioCustom)?string["0.00"]}"<#else>ImporteP="${(((ImpuestosPTraslados_importe[baseTkey]?string["0.00"])?number*tasaCuota?number)/tipocambioCustom)?string["0.00"]}"</#if></#if>/>
                                                <#else>
