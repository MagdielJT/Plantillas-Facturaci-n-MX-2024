	...
	<table class="itemtable" style="width: 100%; margin-top: 10px;">
		...
		<#list listItem as tranline>
			...
			<tr>
				...
				<td colspan="4">
					${tranline.inventoryDetail.inventorynumber.text}
					<#if (tranline.inventoryDetail.quantity?length > 0 )>
						(${tranline.inventoryDetail.quantity})
					</#if>
				</td>
